...
function FeaturedProducts() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/products/featured`)
      .then(r => r.json())
...
function BestSellers() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/products/bestsellers`)
      .then(r => r.json())
