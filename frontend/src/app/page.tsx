...
function FeaturedProducts() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://maintaining-nearby-students-trusts.trycloudflare.com/api'}/products/featured`)
      .then(r => r.json())
...
function BestSellers() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://maintaining-nearby-students-trusts.trycloudflare.com/api'}/products/bestsellers`)
      .then(r => r.json())
